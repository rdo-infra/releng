...
projects_git_url["distroinfo"]="https://github.com/softwarefactory-project/distroinfo"
projects_git_url["dlrn"]="https://github.com/softwarefactory-project/DLRN"
...
projects_git_url["packstack"]="https://github.com/redhat-openstack/packstack"
projects_git_url["puppet-openstack-integration"]="https://github.com/openstack/puppet-openstack-integration"
...
projects_git_url["rdo-website"]="https://review.rdoproject.org/cgit/rdo-website/"
projects_git_url["rdoinfo"]="https://github.com/redhat-openstack/rdoinfo.git"
projects_git_url["rdopkg"]="https://github.com/softwarefactory-project/rdopkg"
...
function rdo_clone_repo {
    ...
    if [[ -d "$repo_name" ]]; then
        ...
        clone_status=$(git clone ${projects_git_url[$repo_name]} $repo_name 2>&1)
        if [ $? -eq 0 ]; then
