...
def get_repos(release):
    RDO_TRUNK_C8 = {
        "baremetal": "http://trunk.rdoproject.org/centos8-%s/component/baremetal/current" % release, # noqa
        "cinder": "http://trunk.rdoproject.org/centos8-%s/component/cinder/current" % release, # noqa
        "clients": "http://trunk.rdoproject.org/centos8-%s/component/clients/current" % release, # noqa
        "cloudops": "http://trunk.rdoproject.org/centos8-%s/component/cloudops/current" % release, # noqa
        "common": "http://trunk.rdoproject.org/centos8-%s/component/common/current" % release, # noqa
        "compute": "http://trunk.rdoproject.org/centos8-%s/component/compute/current" % release, # noqa
        "glance": "http://trunk.rdoproject.org/centos8-%s/component/glance/current" % release, # noqa
        "manila": "http://trunk.rdoproject.org/centos8-%s/component/manila/current" % release, # noqa
        "network": "http://trunk.rdoproject.org/centos8-%s/component/network/current" % release, # noqa
        "octavia": "http://trunk.rdoproject.org/centos8-%s/component/octavia/current" % release, # noqa
        "security": "http://trunk.rdoproject.org/centos8-%s/component/security/current" % release, # noqa
        "swift": "http://trunk.rdoproject.org/centos8-%s/component/swift/current" % release, # noqa
        "tempest": "http://trunk.rdoproject.org/centos8-%s/component/tempest/current" % release, # noqa
        "tripleo": "http://trunk.rdoproject.org/centos8-%s/component/tripleo/current" % release, # noqa
        "ui": "http://trunk.rdoproject.org/centos8-%s/component/ui/current" % release, # noqa
        "component": "http://trunk.rdoproject.org/centos8-%s/component/validation/current" % release, # noqa
