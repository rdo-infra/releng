...
def get_repos(release):
    RDO_TRUNK_C8 = {
        "baremetal": "http://trunk.rdoproject.org/centos8-%s/component/baremetal/current" % release,
        "cinder": "http://trunk.rdoproject.org/centos8-%s/component/cinder/current" % release,
        "clients": "http://trunk.rdoproject.org/centos8-%s/component/clients/current" % release,
        "cloudops": "http://trunk.rdoproject.org/centos8-%s/component/cloudops/current" % release,
        "common":"http://trunk.rdoproject.org/centos8-%s/component/common/current" % release,
        "compute": "http://trunk.rdoproject.org/centos8-%s/component/compute/current" % release,
        "glance": "http://trunk.rdoproject.org/centos8-%s/component/glance/current" % release,
        "manila": "http://trunk.rdoproject.org/centos8-%s/component/manila/current" % release,
        "network": "http://trunk.rdoproject.org/centos8-%s/component/network/current" % release,
        "octavia": "http://trunk.rdoproject.org/centos8-%s/component/octavia/current" % release,
        "security": "http://trunk.rdoproject.org/centos8-%s/component/security/current" % release,
        "swift": "http://trunk.rdoproject.org/centos8-%s/component/swift/current" % release,
        "tempest": "http://trunk.rdoproject.org/centos8-%s/component/tempest/current" % release,
        "tripleo": "http://trunk.rdoproject.org/centos8-%s/component/tripleo/current" % release,
        "ui": "http://trunk.rdoproject.org/centos8-%s/component/ui/current" % release,
        "component": "http://trunk.rdoproject.org/centos8-%s/component/validation/current" % release,
        "deps": "http://trunk.rdoproject.org/centos8-%s/deps/latest" % release,
        "build-deps": "http://trunk.rdoproject.org/centos8-%s/build-deps/latest" % release,
        "deps-srpm": "http://trunk.rdoproject.org/centos8-%s/deps/latest/SRPMS" % release,
        "build-srpm": "http://trunk.rdoproject.org/centos8-%s/build-deps/latest/SRPMS" % release,
        "baseos": "http://mirror.centos.org/centos/8-stream/BaseOS/x86_64/os/",
        "appstream": "http://mirror.centos.org/centos/8-stream/AppStream/x86_64/os/",
        "baseos-srpm": "https://vault.centos.org/centos/8-stream/BaseOS/Source/",
        "appstream-srpm": "https://vault.centos.org/centos/8-stream/AppStream/Source/",
    }
...
def main():
    ...
    parser.add_argument("--release", choices=["wallaby", "victoria"],
                        default="rawhide")
    ...
    for dep in dependants:
        print(dep.name + "-" + dep.evr + "." + dep.arch + " from " + str(dep.reponame))
