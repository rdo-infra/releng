...
def parse_args():
    parser = argparse.ArgumentParser(description='Update rdoinfo tags according to contents'
                                     'of upper-contraints.txt')
    parser.add_argument('-t', '--tag', dest='tag',
                        default='stein-uc',
                        help='tag to update')
    parser.add_argument('-l', '--rdoinfo-location', dest='location', default='.',
                        help='rdoinfo location')
...
def update_uc():
    ...
    distroinfo = info.DistroInfo(info_files='rdo-full.yml', local_info=rdoinfo_dir)
